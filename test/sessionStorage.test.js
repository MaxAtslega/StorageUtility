...
describe('sessionStorage', () => {
  ...
  it('get', async () => {
    const storageType = new ScStorage({ STORAGE_TYPE: StorageType.SESSION_STORAGE, AS_OBJECT: true })
  ...
  it('has', async () => {
    const storageType = new ScStorage({ STORAGE_TYPE: StorageType.SESSION_STORAGE })
